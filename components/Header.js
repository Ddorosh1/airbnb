  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10" >
        ...
        <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
            ...
            <SearchIcon onClick={search} className="hidden md:inline h-8 bg-red-400 text-white rounded-full p-2 cursor-pointer md:mx-2" />
        </div>
        ...
        {searchInput && (
            <div className="flex flex-col col-span-3 mx-auto mt-4">
                ...
                <div className="flex items-center border-b mb-4">
                    ...
                    <input value={numOfGuests} onChange={e => setNumOfGuests(e.target.value)} min={1} type="number" 
